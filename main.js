    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            Swal.fire({
                ...
                text: 'Chúc Nhi có 1 ngày 20-10 vui vẻ 😊, một ngày thật đằm thắm, cố gắng vượt qua khó khăn trong cuộc sống, vươn xa hơn và đi tới hạnh phúc, quan trọng chúc bạn nhanh khỏi ốm🥰🥰🥰',
                imageUrl: 'img11.jpg',
                background: '#fff url("iput-bg.jpg")',
                imageAlt: 'Custom image',
                confirmButtonText: 'Tiếp theo!😘'
